...
const sections = [
   {
    title: `✃ INFO`,
	rows: [
	    {title: "🔮WhatsApp Imune 1", rowId: '.waimune1', description: 'Jangan lupa Subs Yt OHLX GT' },
	    {title: "🔮WhatsApp Imune 2", rowId: '.waimune2', description: 'Jangan lupa subs Yt OHLX GT' },
	{title: "🔮WhatsApp Gb Kebal 1", rowId: '.wagb1', description: 'Jangan lupa subs Yt OHLX GT' },
